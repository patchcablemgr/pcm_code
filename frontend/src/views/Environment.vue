...
import ComponentCabinetDetails from '@/views/templates/ComponentCabinetDetails.vue'
...
export default {
  ...
  computed: {
    ...
    CablePathsReady: function() {
      return this.$store.state.pcmCablePaths.CablePathsReady
    },
    Categories() {
