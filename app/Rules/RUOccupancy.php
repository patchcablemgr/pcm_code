...
class RUOccupancy implements Rule
{
	 ...
	 * @param  int  $cabinetRU
     * @param  int  $cabinetFace
     * @return bool
     */
    public function __construct($objectID, $locationID, $templateID, $cabinetRU, $cabinetFace, $archiveAddress)
    {
    ...
    public function passes($attribute, $value)
    {
        ...
        if($collision) {
            return ['cabinet_ru' => 'Destination RU is occupied.'.$this->archiveAddress];
        } else {
            return true;
        }
    }
